...
# ========== UPDATED: Initialize with Qdrant support ==========
...
async def add_web_page(request: WebPageRequest):
...
async def add_text_content(request: TextContentRequest):
...
async def batch_process_directory(request: BatchProcessRequest):
...
async def remove_content(request: RemoveContentRequest):
