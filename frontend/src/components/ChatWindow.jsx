...
function ChatWindow({ selectedPersona, personaInfo, selectedChat, newChatTrigger, currentSessionId, onSessionCreated }) {
  ...
  const showWelcomeMessage = () => {
    ...
    const welcomeMessages = {
      local_guide: "Hey there! I'm your Local Guide. I've been exploring India for years and know all the insider tips. What brings you to this Spiritual Hub? Planning a Char Dham trip, or looking for some adventure?",
      spiritual_teacher: " Namaste, blessed soul. I am honored to guide you through the spiritual essence to this incredibly large Spiritual Hub. Each temple, each river, each peak here resonates with divine energy. What aspect of this holy land calls to your heart?",
      ...
      cultural_expert: " Namaste and welcome! As a Cultural Expert, I'll unveil the rich tapestry of myths, legends, and traditions woven into India's landscape. Every stone here has a story spanning millennia. What cultural aspect would you like to explore?"
    }
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-4 text-white">
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-indigo-100">{personaInfo?.description || 'Your guide to India'}</p>
          </div>
          {sessionId && (
