...
export default function SeasonToggle({
  ...
  return (
    <button
      ...
      className="fixed top-6 right-6 md:right-12 md:top-8 z-50 group cursor-pointer w-[60px] h-[60px] md:w-[100px] md:h-[100px]"
      title="Change Season"
      style={{
    ...
    >
      ...
      {/* Tooltip on Hover */}
      <div className="hidden md:block absolute -bottom-12 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
